...
router.get("/Product/Overview/supplierDetails", auth, controllers.productController.getSupplierDetails);
router.get("/Product/Overview/stockLocations", auth, controllers.productController.getStockLocations);

router.get("/Product/Movement", auth, controllers.productController.productMovement);
router.get("/Product/Movement/getQuantityDetails",  controllers.productController.getQuantityDetails);
...
router.get("/Inventory/topSelling",   auth, controllers.InventoryController.getTopSellingProduct );
